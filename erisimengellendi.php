...
<br>
<br>
		<h1 class="at" align="center">&#9940;ERİŞİM ENGELLENDİ!!</h1>
				<h3 style="font-family:Times New Roman" align="center">Web Sayfamızı daha önce ziyaret ettiniz ve engellendiniz.Erişim engelinizi kaldırıp yeni bildirim yapabilmeniz için Yönetici ile iletişime geçiniz.</h3>
		<center><img src="image/KGM_Logo.png"  style="opacity:0.3;width:35%"></center>
				<center><a href="index.php"><h3>ANA SAYFAYA DÖN</h3></a></center>
    <!-- Optional JavaScript -->
