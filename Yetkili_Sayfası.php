...
?>>
	  ...
	  <div class="col-md-9">
	  	  <h3 align="center">Güncel Yol Sorunları </h3>
  ...
  <?php
			...
			while($kayit=$sonuc->fetch_assoc())
			{
				...
				if($_SESSION['rol']==$kayit['sehir']&&$kayit['durum']!="Çözüldü"&&$_SESSION['rol']!="9.Bölge Müdürlüğü")
				{
					$durum=$kayit['sehir'];
	  ?>
...
<?php
			...
			<span align="right">&#10071;</span>
			   <span style="font-weight:bold" >Lütfen Bir Şubeye Yönlendirme Yapınız</span>
		     </div>
		  <div class="card-body">
			<p class="card-text"><span style="font-weight:bold">Bildirim:</span>  <?php echo $kayit['yol_sorunu'];?></p>
	  ...
	  <br>
	    		<center><input type="submit" class="btn btn-outline-primary btn1"  name="yonlendir" id="myBtn" value="&#9194; Yönlendir" >
